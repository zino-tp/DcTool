...
def display_results(valid_tokens, invalid_tokens, valid_nitro, invalid_nitro, valid_proxies, invalid_proxies):
    Write.Print(Box.DoubleLine("Results", width=50), Colors.green_to_cyan, interval=0.000)
    ...
    Write.Print(Box.DoubleLine("", width=50), Colors.green_to_cyan, interval=0.000)
